...
class OfflineEnv:
    ...
    def __init__(
        ...
        obstacles: Optional[List[Tuple[int, int]]] = None, # 障害物の座標リスト
    ) -> None:
        ...
        self.obstacles = obstacles if obstacles else [] # 障害物の初期化
    ...
    def step(self, action: int) -> Tuple[int, float, bool, bool, Dict]:
        ...
        if (
            ...
            and (new_x, new_y) not in self.obstacles # <--- 障害物でないかチェック
        ):
    ...
    def _respawn_target(self) -> None:
        ...
        free = [
            ...
            and (x, y) not in self.obstacles  # 障害物を避ける
        ]
